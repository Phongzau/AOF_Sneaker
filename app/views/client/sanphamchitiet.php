	                ...
	                <div class="all">
	                    <div class="slider">
	                        <div class="owl-carousel owl-theme main">
	                            <div style="background-image: url(public/client/img/products/shoes/1.jpg);" class="item-box"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/2.jpg);" class="item-box"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/3.jpg);" class="item-box"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/4.jpg);" class="item-box"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/5.jpg);" class="item-box"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/6.jpg);" class="item-box"></div>
	                        </div>
	                    ...
	                    <div class="slider-two">
	                        <div class="owl-carousel owl-theme thumbs">
	                            <div style="background-image: url(public/client/img/products/shoes/1.jpg);" class="item active"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/2.jpg);" class="item"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/3.jpg);" class="item"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/4.jpg);" class="item"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/5.jpg);" class="item"></div>
	                            <div style="background-image: url(public/client/img/products/shoes/6.jpg);" class="item"></div>
	                        </div>
