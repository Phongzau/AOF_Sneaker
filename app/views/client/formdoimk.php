				...
				<div class="col-xl-6 col-lg-6 col-md-8">
					<div class="box_account">
						...
						<div class="form_container">
							<form action="index.php?cl=th_doimatkhau" method="POST">
							...
							<div class="text-center"><input type="submit" value="Đổi mật khẩu" name="th_doimatkhau" class="btn_1 full-width"></div>
